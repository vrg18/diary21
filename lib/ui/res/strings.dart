...
const String loginForgotPress = 'Забыл пароль';
const String fillWithTestUserData = 'Тестовый\nпользователь';
const String loginTestUser = 'test@test.pro';
const String passwordTestUser = '12345678';
const String loginAndPassEmpty = 'E-mail и пароль должны быть заполнены';
...
const String dateHint = 'дата';
const String timeStartHint = 'старт';
const String timeFinishHint = 'финиш';
const String deedNameHint = 'название дела';
